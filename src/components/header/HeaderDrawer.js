...
class HeaderDrawer extends Component {
  ...
  handleLogout = (e) => {
    ...
    this.props.authStore.logout().then(() => {
      window.location.href = UrlService.createUrl(window.location.host, (this.props.orgStore.currentOrganisation ? '/' + this.props.orgStore.currentOrganisation.tag : '') + '/signin', null);
    });
  }
